const paymentMethods = [
  { id: "credit", name: "Crédito / Débito", hasLogos: true },
  { id: "nequi", name: "NEQUI" },
  { id: "pix", name: "PIX" },
...
const PaymentSection = ({ selectedPayment, onSelectPayment }: PaymentSectionProps) => {
  return (
      ...
      <div className="grid grid-cols-4 gap-2">
        {paymentMethods.map(method => (
          <div
            ...
            className={`payment-card flex flex-col items-center justify-center min-h-[65px] text-center ${
