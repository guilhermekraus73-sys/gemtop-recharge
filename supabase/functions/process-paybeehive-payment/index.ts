...
// Price mapping for each package - Método de Mejores Prácticas (amount in cents USD)
const PRICES: Record<string, { amount: number; diamonds: number; description: string }> = {
  "1": { amount: 100, diamonds: 100, description: "Método de Mejores Prácticas - Test" },           // $1.00 USD (test)
  "9": { amount: 900, diamonds: 5600, description: "Método de Mejores Prácticas" },         // $9.00 USD
  "15": { amount: 1590, diamonds: 11200, description: "Método de Mejores Prácticas Plus" },     // $15.90 USD
  "19": { amount: 1900, diamonds: 22400, description: "Método de Mejores Prácticas Pro" },     // $19.00 USD
};
  ...
  try {
    ...
    const response = await fetch("https://api.utmify.com.br/api-credentials/orders", {
      ...
      body: JSON.stringify({
        ...
        products: [
          {
            id: "metodo-mejores-practicas",
            name: "Método de Mejores Prácticas",
            planId: "",
            planName: "",
            quantity: 1,
            priceInCents: amount,
